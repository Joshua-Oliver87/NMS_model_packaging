...
import './wsu-design-system.css';

function Footer() {
  return (
    <div class="main-footer">
      {/* Main Site Footer */}
      <footer className="wsu-footer-site">
        <div className="wsu-footer-site__content">
          <ul className="wsu-social-icons"></ul>
          <div className="wsu-meta-address">
            Prosser IAREC, 24106 North Bunn Road, Prosser, WA, 99350
          </div>
          <svg   
            tabindex="-1"
            role="img"
            aria-labelledby="wsuLogoTitle"
            className="wsu-coug-head wsu-coug-head--white"
      ...
      {/* Global Footer */}
      <footer className="wsu-footer-global">
        <div className="wsu-footer-global__copyright">
          © Washington State University 2025
        </div>
        <nav className="wsu-footer-global__navigation">
          <ul className="wsu-menu-tertiary">
            <li>
